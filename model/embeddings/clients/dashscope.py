...
class DashScopeClientCfg:
    ...
    @classmethod
    def embed_documents(cls,model_name: str,input: Union[str, List[str]],text_type: str="document") -> str:
    ...
    @classmethod
    def embed_multi_independent(cls,model_name: str,input: List[Dict[str, str]], text_type: str = "document",isfusion=False) -> List[str]:
        '''
        输入可以是视频
