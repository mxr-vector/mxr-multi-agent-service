...
<template>
    <section class="system-page list-page">
        ...
        <!-- 重置密码 弹窗 -->
        <el-dialog v-model="pwdDialogVisible" :title="`重置密码：${pwdTarget?.username ?? ''}`" width="440px">
            ...
            <template #footer>
                ...
                <el-button type="primary" :loading="pwdSubmitting" @click="submitResetPassword">确定</el-button>
            </template>
        </el-dialog>

        <!-- 分配角色 弹窗 -->
        <el-dialog v-model="roleDialogVisible" :title="`分配角色：${roleTarget?.username ?? ''}`" width="440px">
            ...
            <template #footer>
                ...
                <el-button type="primary" :loading="roleSubmitting" @click="submitAssignRoles">保存</el-button>
            </template>
        </el-dialog>
    </section>
</template>
