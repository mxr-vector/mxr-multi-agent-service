            ...
            <el-table class="list-scroll" :data="list">
                ...
                <el-table-column label="操作" width="120" fixed="right">
                    <template #default="{ row }">
                        ...
                        <el-button v-else link type="danger" size="small" @click="removeConfig(row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <template #footer>
        ...
        <FormDialog v-model="dialogVisible" :title="editing ? '编辑参数' : '新建参数'" :submitting="submitting"
            ...
            <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
                ...
                <el-form-item label="参数键" prop="key">
                    <el-input v-model="form.key" placeholder="如：sys.user.init_password（全局唯一）" maxlength="100" />
                </el-form-item>
