...
import { chunkApi, type Chunk } from "@/api/rag/chunks";
    ...
    <ul v-if="nodes.length" class="chunk-list">
      ...
      >
        ...
        <div class="chunk-body">
          <strong v-if="node.chunk.chapter_title" class="chunk-title">
            {{ node.chunk.chapter_title }}
          </strong>
          <p class="chunk-content">{{ preview(node.chunk.content) }}</p>
          <span class="chunk-meta">
            <template v-if="node.chunk.token_count != null">
              {{ node.chunk.token_count }} tokens
            </template>
            <template v-if="node.chunk.page_start != null">
              · P{{ node.chunk.page_start }}
              <template
