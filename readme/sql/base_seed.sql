...
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019fb5e7-d9cf-7066-a0a5-8b34a8c077fb', '重排序最终候选数', 'RAG_FINAL_TOP_K', '5', true, '重排序后保留的最终候选数量(top-k)', '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:01:38.510209 +00:00');
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019fb5e7-d9cf-7087-a5f4-8ea3b049c9e7', '反思检索轮数上限', 'RAG_REFLECT_ROUND_CAP', '3', true, '反思循环最大检索轮数上限', '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:01:38.510209 +00:00');
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019fb5e7-d9cf-7095-a47b-946fe95b3005', 'checkpoint 保留天数', 'CHAT_CHECKPOINT_TTL_DAYS', '7', true, 'LangGraph checkpoint 保留天数, 超期由后台任务清理', '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:01:38.510209 +00:00');
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019fb5e7-d9cf-70a5-8ed2-277056efad89', '回落历史消息条数上限', 'CHAT_HISTORY_MAX_MESSAGES', '20', true, 'checkpoint 缺失时 condense 回落业务表读取的历史消息条数上限', '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:01:38.510209 +00:00');
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019fb5e7-d9ce-7e12-b5d9-db5c8d82bcf5', '混合召回候选池大小', 'RAG_CANDIDATE_POOL_SIZE', '50', true, '混合召回(dense+sparse RRF 融合)后保留的候选池上限', '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:35:31.152852 +00:00');
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019fb6c6-95ca-7c4e-a8fe-e99080f18e5a', '自托管DrawIO服务地址', 'DRAWIO_EMBED_URL', 'http://127.0.0.1:8080', true, '绘图设计 自托管DrawIO服务地址', '2026-07-31 06:04:55.622975 +00:00', '2026-07-31 06:05:09.561572 +00:00');
INSERT INTO sys.sys_config (id, name, key, value, is_builtin, remark, created_at, updated_at) VALUES ('019ff44c-8950-7422-9d2c-fe4c49ea7285', '对话输出token上限', 'CHAT_MAX_OUTPUT_TOKENS', '8192', true, '对话模型请求的输出上限(max_tokens)，参与输入预算计算(输入预算=context_window-max_output_tokens-10%边际)', '2026-08-12 04:51:14.171808 +00:00', '2026-08-12 04:59:25.105785 +00:00');
...
INSERT INTO sys.sys_dept (id, parent_id, name, sort_order, leader, status, created_at, updated_at) VALUES ('019fa265-8a56-7fce-b72a-344fe2f8ec87', null, '总部', 0, null, 'active', '2026-07-27 07:06:31.382400 +00:00', '2026-07-27 07:06:31.382400 +00:00');
INSERT INTO sys.sys_dept (id, parent_id, name, sort_order, leader, status, created_at, updated_at) VALUES ('019fa265-8a60-7d41-9e4e-af23b2a6beab', '019fa265-8a56-7fce-b72a-344fe2f8ec87', '研发部', 0, null, 'active', '2026-07-27 07:06:31.391176 +00:00', '2026-07-27 07:06:31.391176 +00:00');
INSERT INTO sys.sys_dept (id, parent_id, name, sort_order, leader, status, created_at, updated_at) VALUES ('019fa265-8a66-7b6e-a330-46a028be8e37', '019fa265-8a56-7fce-b72a-344fe2f8ec87', '市场部', 0, null, 'active', '2026-07-27 07:06:31.397823 +00:00', '2026-07-27 07:06:31.397823 +00:00');
...
('019fa7b2-986d-7df1-a85a-5b17bb62acc7', 'visibility_type', '私有', 'private', 0, true, 'active', null, '2026-07-28 07:48:47.339482 +00:00', '2026-07-28 07:48:51.075894 +00:00'),
...
('019fa7b2-6490-7587-982f-6b4d9d4f5c21', '可见性', 'visibility_type', 'active', null, '2026-07-28 07:48:34.061154 +00:00', '2026-07-28 07:48:34.061154 +00:00'),
...
INSERT INTO sys.sys_menu (id, parent_id, menu_type, name, path, component, label, icon, perms, visible, sort_order, status, created_at, updated_at) VALUES 
 ('01900000-0000-7000-8000-000000000002', '01900000-0000-7000-8000-000000000001', 'menu', 'system-user', '/system/user', 'system-user', '用户管理', 'user', null, true, 1, 'active', '2026-07-27 05:30:44.428008 +00:00', '2026-07-27 05:30:44.428008 +00:00'),
...
INSERT INTO sys.sys_model_config (id, role, name, model_name, api_url, api_key, provider, timeout, max_retries, extra, is_builtin, remark, created_at, updated_at, context_window) VALUES 
('019fb5e7-d9ce-7c78-8917-1e8e5dac84dc', 'visual', '多模态模型', 'step-3.7-flash', 'https://api.stepfun.com/step_plan/v1', '95279527', null, 60, 2, null, true, null, '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:08:56.096100 +00:00', 200000);
...
INSERT INTO sys.sys_role (id, name, role_key, data_scope, sort_order, status, remark, created_at, updated_at) VALUES 
 ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '研究员', 'researcher', 'all', 0, 'active', null, '2026-07-27 06:12:03.105254 +00:00', '2026-07-27 06:12:03.105254 +00:00'),
...
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000002');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000003');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000004');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000005');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000006');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000007');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '019fa2bd-1633-7227-9b62-33848c740ca0');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '019fa2b2-144f-7b3d-9764-178f22b49ae5');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '019fa2b3-6a3f-73f0-bc5a-7adb54c3cf56');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '019fa2bc-83fe-7016-a522-505abbdaf2f4');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '01900000-0000-7000-8000-000000000001');
INSERT INTO sys.sys_role_menu (role_id, menu_id) VALUES ('019fa233-aba6-7e4b-b950-8beb9ae652bf', '019fa292-b518-785e-9422-262b2239df5b');
...
INSERT INTO sys.sys_user (id, username, password, nickname, dept_id, email, phone, avatar, status, remark, created_at, updated_at) VALUES ('01900000-0000-7000-8000-0000000000a1', 'admin', '$2b$12$ZDbTEc7fpaM5878wuIBBEeqj0T32LYtLnsCPWRggRtorRlzRdQiuu', '管理员', null, null, null, null, 'active', null, '2026-07-27 05:49:02.394632 +00:00', '2026-07-27 05:49:02.394632 +00:00');
INSERT INTO sys.sys_user (id, username, password, nickname, dept_id, email, phone, avatar, status, remark, created_at, updated_at) VALUES ('019fa265-8bb9-7872-97d1-47b9c52897b0', 'yx01', '$2b$12$6GNOCSpacPSyPYVrtL7Hy.rAsYoU4ffgZleheOAHbFVUT/Nkm2joK', '市场一号', '019fa265-8a66-7b6e-a330-46a028be8e37', null, null, null, 'active', null, '2026-07-27 07:06:31.573371 +00:00', '2026-07-27 07:54:04.965226 +00:00');
INSERT INTO sys.sys_user (id, username, password, nickname, dept_id, email, phone, avatar, status, remark, created_at, updated_at) VALUES ('019fa265-8b0e-7d2e-90a0-2c6a114bd327', 'yg01', '$2b$12$llx6T92WUUBP6wzuJuqwZebqNJw72LDlM.T2VqUXpdmMis1O.6zEi', '研发一号', '019fa265-8a60-7d41-9e4e-af23b2a6beab', null, null, null, 'active', null, '2026-07-27 07:06:31.403725 +00:00', '2026-07-27 07:54:13.483248 +00:00');
...
INSERT INTO sys.sys_user_role (user_id, role_id) VALUES ('019fa265-8b0e-7d2e-90a0-2c6a114bd327', '019fa23b-f8b7-7bd3-814d-81334345475f');
INSERT INTO sys.sys_user_role (user_id, role_id) VALUES ('019fa265-8bb9-7872-97d1-47b9c52897b0', '019fa23c-7523-7770-ab1e-4b56dec4ba07');
INSERT INTO sys.sys_user_role (user_id, role_id) VALUES ('01900000-0000-7000-8000-0000000000a1', '019fa2ee-842e-794b-bf3b-76fe95c78a83');
