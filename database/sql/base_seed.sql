...
values  ('019fa7b2-986d-7df1-a85a-5b17bb62acc7', 'visibility_type', '私有', 'private', 0, true, 'active', null, '2026-07-28 07:48:47.339482 +00:00', '2026-07-28 07:48:51.075894 +00:00'),
        ...
        -- 剧本基调 story_tone: 剧本生成与视频分镜的情感与氛围基调，前端「剧本创作」下拉数据源
        ('01a0d1e2-0002-7000-8000-000000000601', 'story_tone', '史诗', '史诗', 0, false, 'active', '宏大叙事、大景别大航拍、庄严浩瀚', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000602', 'story_tone', '空灵', '空灵', 1, false, 'active', '风光建筑、留白意境、极简光影', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000603', 'story_tone', '仙气', '仙气', 2, false, 'active', '上美影国风、青瓷绿月白、云雾缥缈', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000604', 'story_tone', '禅意', '禅意', 3, false, 'active', '古刹青苔、水墨微澜、宁静深远', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000605', 'story_tone', '治愈', '治愈', 4, false, 'active', '温暖明快、舒缓从容、生活绘本', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000606', 'story_tone', '悬疑', '悬疑', 5, false, 'active', '阴翳交织、荷式仰拍、紧迫压抑', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000607', 'story_tone', '热血', '热血', 6, false, 'active', '动作交锋、锣鼓铿锵、快节奏冲突', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000608', 'story_tone', '悲壮', '悲壮', 7, false, 'active', '赭石浓墨、风雪残阳、宿命反抗', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000609', 'story_tone', '苍凉', '苍凉', 8, false, 'active', '大漠孤烟、古道西风、天地悠悠', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000610', 'story_tone', '庄严', '庄严', 9, false, 'active', '中轴对称、厚重石构、肃穆沉静', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000611', 'story_tone', '温馨', '温馨', 10, false, 'active', '蜡笔暖色、细腻情感、家庭日常', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000612', 'story_tone', '幽默', '幽默', 11, false, 'active', '民间诙谐、夸张造型、机智妙趣', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000613', 'story_tone', '神性', '神性', 12, false, 'active', '鎏金重彩、法象森罗、天界异象', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000614', 'story_tone', '诡秘', '诡秘', 13, false, 'active', '绛紫暗墨、志怪异兽、迷雾重重', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000615', 'story_tone', '科幻', '科幻', 14, false, 'active', '赛博霓虹、金属光泽、未来机械', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000616', 'story_tone', '童趣', '童趣', 15, false, 'active', '稚拙线条、蜡笔纯色、天马行空', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000617', 'story_tone', '怀旧', '怀旧', 16, false, 'active', '老照片色、旧报纸感、岁月流金', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        -- 角色分类 story_role_type: 剧本角色定位分类
        ('01a0d1e2-0002-7000-8000-000000000701', 'story_role_type', '主角', 'protagonist', 0, true, 'active', '核心主角', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000702', 'story_role_type', '配角', 'supporting', 1, false, 'active', '关键重要配角', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000703', 'story_role_type', '反派', 'antagonist', 2, false, 'active', '主要反派/对抗角色', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000704', 'story_role_type', 'NPC', 'npc', 3, false, 'active', '过场/路人/背景人物', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0002-7000-8000-000000000705', 'story_role_type', '其他', 'other', 4, false, 'active', '其他非标准角色', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00');
--
...
values  ('019fa7b2-6490-7587-982f-6b4d9d4f5c21', '可见性', 'visibility_type', 'active', null, '2026-07-28 07:48:34.061154 +00:00', '2026-07-28 07:48:34.061154 +00:00'),
        ...
        ('01a0d1e2-0001-7000-8000-000000000501', '剧本基调', 'story_tone', 'active', '剧本与视频生成的情感/视听基调', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00'),
        ('01a0d1e2-0001-7000-8000-000000000502', '角色分类', 'story_role_type', 'active', '剧本角色定位分类(主角/配角/反派等)', '2026-09-18 06:00:00 +00:00', '2026-09-18 06:00:00 +00:00');
