...
values  ('019fa7b2-986d-7df1-a85a-5b17bb62acc7', 'visibility_type', '私有', 'private', 0, true, 'active', null, '2026-07-28 07:48:47.339482 +00:00', '2026-07-28 07:48:51.075894 +00:00'),
        ...
        -- 图像模型生图规格档位: image 角色 sys_model_config.extra 的可选值, 前端「模型管理」下拉数据源。
        -- 取值域对齐 OpenAI 兼容 images/generations, 上游换供应商时增删字典项即可, 无需改代码。
        ('01a0c1d2-0002-7000-8000-000000000301', 'image_size', '自动', 'auto', 0, false, 'active', '由上游按 prompt 自选尺寸, 无法识别时按 2K 档兜底计费', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000302', 'image_size', '方图 1024x1024', '1024x1024', 1, true, 'active', '最长边 1024px(1K 档)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000303', 'image_size', '横版 1536x1024', '1536x1024', 2, false, 'active', '最长边 1536px(2K 档)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000304', 'image_size', '竖版 1024x1536', '1024x1536', 3, false, 'active', '最长边 1536px(2K 档)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000305', 'image_size', '方图 2048x2048', '2048x2048', 4, false, 'active', '最长边 2048px(2K 档)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000306', 'image_size', '方图 4096x4096', '4096x4096', 5, false, 'active', '最长边 4096px(4K 档)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000401', 'image_quality', '自动', 'auto', 0, true, 'active', '由上游按 size 与 prompt 自选质量档', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000402', 'image_quality', '低', 'low', 1, false, 'active', '出图最快, 适合草图与批量备选', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000403', 'image_quality', '中', 'medium', 2, false, 'active', '速度与细节折中', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0002-7000-8000-000000000404', 'image_quality', '高', 'high', 3, false, 'active', '细节最好, 耗时与消耗最高', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00');
--
...
values  ('019fa7b2-6490-7587-982f-6b4d9d4f5c21', '可见性', 'visibility_type', 'active', null, '2026-07-28 07:48:34.061154 +00:00', '2026-07-28 07:48:34.061154 +00:00'),
        ...
        ('01a0c1d2-0001-7000-8000-000000000201', '图像尺寸', 'image_size', 'active', '图像模型生图尺寸档位(extra.size)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00'),
        ('01a0c1d2-0001-7000-8000-000000000202', '图像质量', 'image_quality', 'active', '图像模型生图质量档位(extra.quality)', '2026-09-03 06:00:00 +00:00', '2026-09-03 06:00:00 +00:00');
...
-- image 角色: 可调生图规格(size/quality)落 extra(JSONB), 由 model/image/factory.py 归一为
--             images/generations 入参; 输出侧写死不入 extra(工厂常量 OUTPUT_FORMAT=webp /
--             OUTPUT_COMPRESSION=80); timeout 取 600s(生图耗时远长于对话, 不套用 chat 的 60s),
--             NULL 时回落 SDK 默认 600s
...
values  ('019fb5e7-d9ce-7c78-8917-1e8e5dac84dc', 'visual', '多模态模型', 'glm-5.3-flash', 'https://opencode.ai/zen/go/v1', '95279527', null, 60, 2, null, true, null, '2026-07-31 02:01:38.510209 +00:00', '2026-07-31 02:08:56.096100 +00:00', 200000),
        ...
        ('019ff50f-47ad-767b-98fe-f3fa59f511f1', 'image', '图像模型', 'gpt-image-2', 'https://api.openai.com/v1', '95279527', null, 600, 2, '{"size": "1024x1024", "quality": "auto"}'::jsonb, true, '可调生图规格存 extra(size/quality), 输出侧写死 webp + 压缩率 80, 前端「模型管理」可配、免重启生效', '2026-08-12 08:20:47.149101 +00:00', '2026-09-03 06:00:00 +00:00', 200000);
